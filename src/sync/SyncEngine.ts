...
export interface SyncStateStore {
  ...
  commitInbound(messages: InboundSyncMessage[], nextCursor: number, now?: number, dropped?: DroppedInboundSyncMessage[]): Promise<void>;
}
...
function isStaleCursorAck(cause: unknown): boolean {
  return cause instanceof CloudClientError && cause.code === 'ACK_NOT_DELIVERED';
}
